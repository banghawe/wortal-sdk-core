...
export default class SDKConfig {
    ...
    _supportedAPIs: Record<Platform, string[]> = {
        ...
        crazygames: [
            ...
            WORTAL_API.PLAYER_SHOW_AUTH_PROMPT_ASYNC,
            WORTAL_API.PLAYER_SHOW_LINK_ACCOUNT_PROMPT_ASYNC,
...
export const WORTAL_API= {
    ...
    PLAYER_SHOW_AUTH_PROMPT_ASYNC: "player.showAuthPromptAsync",
    PLAYER_SHOW_LINK_ACCOUNT_PROMPT_ASYNC: "player.showLinkAccountPromptAsync",
...
export const API_URL = {
    ...
    PLAYER_SHOW_AUTH_PROMPT_ASYNC: "https://sdk.html5gameportal.com/api/wortal/#playershowauthpromptasync",
    PLAYER_SHOW_LINK_ACCOUNT_PROMPT_ASYNC: "https://sdk.html5gameportal.com/api/wortal/#playershowlinkaccountpromptasync",
